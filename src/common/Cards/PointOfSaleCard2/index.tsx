...
const PointOfSaleCard2 = ({ title, description, solutionBadge = "Solutions", href = "", image, isShowSolution = false, onProductClick, ...props }: PointOfSaleCard2Props) => {
            ...
            <Card.Body className='ps-0'>
                ...
                <div className='d-flex flex-column justify-content-start align-items-start'>
                    ...
                    <div className='d-flex h-100 justify-content-start align-items-center gap-3'>
                        <TalkToAnExpertButton text='Talk to Expert' className='btn btn-feature' />
                        <button onClick={onProductClick} className='btn btn-outline-feature'>Product Details</button>
                    </div>
                </div>
            </Card.Body>
        </Card>
