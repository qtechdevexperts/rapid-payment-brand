                            ...
                            return (
                                <div className="col-md-4">
                                    <PointofSaleCard
                                        ...
                                        desc={'Streamline your operations with feature-rich POS systems designed for efficiency, security, and seamless transactions—ideal for retail, restaurants, and service businesses.'}
                                    />
                                </div>
                            )
                        })
