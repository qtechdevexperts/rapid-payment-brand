      ...
      <section className="py-10">
        <Container className="d-flex flex-column justify-content-center align-items-center">
          <h2 className="heading-3 fw-normal text-capitalize text-center">
            From small businesses to enterprise <br /> empires, we{' '}
            <span className="fw-bold">lead the way.</span>
          </h2>
          <p className="para max-w-sm-65 text-center mx-auto">
          ...
          <Row className="mt-7">
            <Col md={3}>
              <ProcessingFeeCard
                title={'in Person'}
                description={
                  'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidint ut labore et dolore magna aliqua eiusmod dolor sit.'
                }
              />
            </Col>
            <Col md={3}>
