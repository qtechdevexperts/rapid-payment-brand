...
import { InpersonPaymentService, OmniChannelService, OnlinePaymentServices } from "@/utils/data";
  ...
  return (
    <>
      <Hero
        ...
        description={'Rapid Payments, a leading merchant service provider, partners with top payment processors, gateways, and POS providers to deliver a truly unified payment experience. Accept payments in-store, online, or via mobile with a seamless and secure solution that connects all sales channels.'}
      />
