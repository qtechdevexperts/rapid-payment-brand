...
const OnlinePayments = () => {
  return (
    <>
      ...
      <Hero
        title='<span class="text-secondary-standard  fw-bold"> In-Person </span> <br /> <span class="fw-bold text-primary-standard">Payments</span> '
      ...
      <IntegratationOption
        title={
          '<span class="text-secondary-standard fw-bold">Fast, secure and flexible In-Person </span> <br /> <span class="fw-bold text-primary-standard">payment solutions​</span> '
        }
        data={InpersonPaymentService}
      />

      <Hero
        title='<span class="text-secondary-standard fw-bold"> Get Paid Anywhere, <br class="d-none d-lg-block" /> Anytime with Seamless </span> <br  class="d-none d-lg-block" /> <span class="fw-bold text-primary-standard">In-Person Payments!</span> '
