...
const OnlinePayments = () => {
  return (
    <>
      ...
      <Hero
        title='In-Person <br /> <span class="fw-bold text-primary-standard">Payments</span> '
      ...
      <IntegratationOption
        title={
          'Fast, secure and flexible In-Person <br /> <span class="fw-bold text-primary-standard">payment solutions​</span> '
        }
        data={InpersonPaymentService}
      />

      <Hero
        title='Get Paid Anywhere, <br class="d-none d-lg-block" /> Anytime with Seamless <br  class="d-none d-lg-block" /> <span class="fw-bold text-primary-standard">In-Person Payments!</span> '
