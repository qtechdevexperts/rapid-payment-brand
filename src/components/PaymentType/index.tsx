            ...
            <Row>
                <Col lg={8}>
                    <h4 className="heading-3 fw-normal">
                        At <span className="fw-bold">Rapid Payment</span> , Accept <br /> Payments
                        Anytime, Anywhere
                    </h4>
                </Col>
                <Col lg={4}>
            ...
            <Row className="mt-5 gy-3 gy-lg-0">
                ...
                <Col lg={4}>
                    <PaymentCard
                        ...
                        icon={<>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="51" viewBox="0 0 50 51" fill="none">
  <path d="M5.32087 34.0748C5.12058 34.4703 5.19261 34.9493 5.50036 35.2684C5.80812 35.5875 6.28416 35.6769 6.6867 35.4911L11.8937 33.0879C16.2699 31.0681 21.0456 30.1441 25.8131 30.3615C25.8697 31.8924 25.9537 33.4226 26.0652 34.9513L26.2078 36.9075C26.2943 38.0943 27.6176 38.7577 28.6203 38.117C32.9723 35.3361 36.7558 31.7529 39.769 27.5583L40.7277 26.2237C40.9886 25.8605 40.9886 25.3714 40.7277 25.0082L39.769 23.6736C36.7558 19.479 32.9723 15.8958 28.6203 13.1149C27.6176 12.4742 26.2943 13.1376 26.2078 14.3244L26.0652 16.2805C25.9695 17.5927 25.8941 18.906 25.8388 20.22H24.499C17.0387 20.22 10.2122 24.4151 6.84196 31.0708L5.32087 34.0748Z" fill="white"/>
</svg>
                        </>}
